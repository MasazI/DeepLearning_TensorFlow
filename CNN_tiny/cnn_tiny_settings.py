...
# train settings
flags.DEFINE_integer('batch_size', 20, 'the number of images in a batch.')
flags.DEFINE_string('train_tfrecords', 'data/train_kirin_norm_32.tfrecords', 'path to tfrecords file for train.')
