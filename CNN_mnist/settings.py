...
flags.DEFINE_float('learning_rate_decay_factor', 0.09, 'learning rate decay factor.')
...
flags.DEFINE_integer('num_examples_per_epoch_for_train', 1280, 'the number of examples per epoch train.')
