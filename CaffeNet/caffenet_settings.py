...
flags.DEFINE_integer('num_examples_per_epoch_for_train', 100, 'the number of examples per epoch train.')
flags.DEFINE_integer('num_examples_per_epoch_for_eval', 40, 'the number of examples per eposh eval.')
