...
flags.DEFINE_integer('training_data_type', 0 , '0: directly feed, 1: tfrecords')
...
flags.DEFINE_integer('num_examples_per_epoch_for_train', 8, 'the number of examples per epoch train.')
